...
def drop_ikura():
    ...
    #arduino command to drop one bucket
        ...
        time.sleep(0.5)   
        f_t=dc.get()                        #Do we nee dto add a delay here to make sure the next ft value is after the motor is rotated??
        F_pre=f_t[2]
