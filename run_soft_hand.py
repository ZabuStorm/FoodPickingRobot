...
for x in range(0,15):
    ...
    if camera_mode:
        ...
        #----grasp_5 location
        #obj_pose_5, eef_pose_5 = transform_image_to_robot(grasps[4], point_array, cfgdata, arm=lr_arm)
        #print("Grasp | Object 3D location: (%.3f,%.3f,%.3f)" % (*obj_pose_5,))
        #print("Grasp | Robot EEF pose (%.3f,%.3f,%.3f,%.1f,%.1f,%.1f)" % (*eef_pose_5,))
    ...
    def pick_karage1(a):
        ...
        p1=[a[0],a[1],0.300,a[3],a[4],a[5]]
        p2=[a[0],a[1],0.235,a[3],a[4],a[5]]
        p3=[a[0],a[1],a[2]+0.020+0.030-0.002,a[3],a[4],a[5]]
        p4=[0.535,0.331,0.280,a[3],a[4],a[5]]                #Final location
        #p2=[eef_pose[0],eef_pose[1],eef_pose[2],eef_pose[3],eef_pose[4],eef_pose[5]]
        #p2=[eef_pose]
        arm="left"
        
        print(p1,p2,p1)
        success = plan_move(arm,[p1,p2,p3],[1,1,3])
        ...
        #time.sleep(10)
        success = plan_move(arm,[p1,p4],[1,1])
        motion_seq = get_motion()
        clear_motion()
        nxt.playMotion(motion_seq)
    ...
    def pick_karage2(b):
        ...
        p1=[b[0],b[1],0.300,b[3],b[4],b[5]]
        p2=[b[0],b[1],0.235,b[3],b[4],b[5]]
        p3=[b[0],b[1],b[2]+0.020-0.002,b[3],b[4],b[5]]
        p4=[0.535,-0.350,0.280,b[3],b[4],b[5]]                #Final location
